...
Color dark_blue = Color(0xFFFFFFFF);
...
TextStyle whiteItallictTitleStyle = TextStyle(fontSize: 20, fontFamily: "Helvetica", fontStyle: FontStyle.italic, color: Colors.black);